    ...
    return {
        ...
        execute: function() {
            ProductoComponent = (function () {
                function ProductoComponent(router, routeParams, pService, uService, vService) {
                    var _this = this;
                    this.router = router;
                    ...
                    this.pService.getProductById(id).subscribe(function (prod) { return _this.product = prod; }, function (error) { return console.error(error); });
                ...
                ProductoComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, router_1.RouteParams, product_service_1.ProductService, user_service_1.UserService, valoracion_service_1.ValorationService])
                ], ProductoComponent);
