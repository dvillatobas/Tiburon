...
public class DatabaseInitializer implements CommandLineRunner {
	...
	//	userRepository.save(new User("admin", "", "", "", "", "pass", "", "", "ROLE_ADMIN"));
		...
		userRepository.save(new User("david","david","villatobas","666777888","david@gmail.com","1234","/imagenes/users/foto1.jpg","profesional","ROLE_USER"));
		userRepository.save(new User("luis","luis","fernandez","666777888","luis@gmail.com","1234","/imagenes/users/foto2.jpg","particular","ROLE_USER"));
