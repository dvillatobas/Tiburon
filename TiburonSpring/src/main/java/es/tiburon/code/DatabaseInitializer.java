...
public class DatabaseInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//Products
		productRepository.save(new Product( "1/1/16","camaro", 210,1965,"Madrid","imagenes/coches/1.jpg",2500,1,"car","askldfms"));
		productRepository.save(new Product( "155","camaro", 210,1965,"Madrid","imagenes/coches/1.jpg",2500,1,"car","askldfms"));
