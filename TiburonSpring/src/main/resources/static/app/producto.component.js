System.register(['angular2/core', 'angular2/router', './user.service', './product.service', './valoracion.component', './valoracion.service'], function(exports_1, context_1) {
    "use strict";
                ...
                ProductoComponent.prototype.addValoration = function (valoracion, description) {
                    if (this.uService.getLogueado()) {
                        ...
                        if ((valoracion == '') || (description == '')) {
                            ...
                            var comment = new valoracion_service_1.Valoration(this.uService.getNick(this.uService.getIdUserLogued()), valoracion, description);
